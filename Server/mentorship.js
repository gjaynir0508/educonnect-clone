...
const mentors = [
	...
	{ id: 3, name: "Aradhya", experince: 4, university: "VIT", ratings: 4 },
	{ id: 4, name: "John", experince: 4, university: "CU", ratings: 3 },
	{ id: 5, name: "Tom", experince: 3, university: "LPU", ratings: 1 },
];
...
app.put("/:name", (req, res) => {
	const index = mentors.findIndex((c) => c.name === req.params.name);
	if (index === -1) {
		res.status(404).send("Mentor not found");
	} else {
...
app.patch("/:name", (req, res) => {
	...
	if (index === -1) {
		...
		if (req.body.university)
			courseToUpdate.university = req.body.university;
